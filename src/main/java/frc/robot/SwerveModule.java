...
import static frc.robot.Constants.Swerve.CANBUS_STRING;
...
public class SwerveModule {
    ...
    public SwerveModule(int moduleNumber, SwerveModuleConstants moduleConstants){
        ...
        angleEncoder = new CANCoder(moduleConstants.cancoderID, CANBUS_STRING);
        configAngleEncoder();

        /* Angle Motor Config */
        mAngleMotor = new TalonFX(moduleConstants.angleMotorID, CANBUS_STRING);
        configAngleMotor();

        /* Drive Motor Config */
        mDriveMotor = new TalonFX(moduleConstants.driveMotorID, CANBUS_STRING);
        configDriveMotor();
