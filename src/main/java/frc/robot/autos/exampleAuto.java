...
public class ExampleAuto extends SequentialCommandGroup {
    public ExampleAuto(Swerve sSwerve){
        ...
        var thetaController =
            new ProfiledPIDController(
                Constants.AutoConstants.PTHETA_CONTROLLER, 0, 0, Constants.AutoConstants.kThetaControllerConstraints);
        ...
        SwerveControllerCommand swerveControllerCommand =
            new SwerveControllerCommand(
                ...
                thetaController,
                sSwerve::setModuleStates,
                sSwerve);


        addCommands(
            new InstantCommand(() -> sSwerve.resetOdometry(exampleTrajectory.getInitialPose())),
